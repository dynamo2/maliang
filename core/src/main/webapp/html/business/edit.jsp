    ...
    <body>
		...
		function buildHtml(htmlData){
			...
			if(htmlData.type == 'form'){
				htmlObj = TM_formBuilder.newForm(htmlData);
			}
			
			$("#"+htmlData.html_parent).append(htmlObj);
		}
		</script>
		<div id="main"></div>
	</body>
